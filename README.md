# Back project - gestion-donnees

## Project presentation
This project is a web application where the users can import, delete, edit, see and share files with other users or groups. Each user can create, delete, participate in a group and talk to the other members.
