...
export const mockNewToken = faker.internet.jwt({
  payload: { sub: mockUserId },
});
export const mockHashedNewToken = argon2.hash(mockNewToken);
export const mockConfirmToken = faker.internet.jwt({
  payload: { sub: mockUserId },
});
export const mockRefreshToken = faker.internet.jwt({
  payload: { sub: mockUserId },
});
...
export const mockExtraEmail = faker.internet.email({
  allowSpecialCharacters: true,
});

export const mockUsername = faker.string.alphanumeric({
  length: { min: 10, max: 50 },
});

export const mockAccessToken = faker.internet.jwt({
  payload: { sub: mockUserId },
});
export const mockNewRefreshToken = faker.internet.jwt({
  payload: { sub: mockUserId },
});
...
export const mockResponseRefresh: ResponseMessageWithData<{
  access_token: string;
...
export const mockResponseSignin: ResponseMessageWithData<{
  user: loginInterface;
  access_token: string;
  refresh_token: string;
}> = {
